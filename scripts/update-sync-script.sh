#!/usr/bin/env bash
# 更新 sync-worktrees.sh 的 worktree 路径配置

cat > /Users/luoxun/dev/ads/server/ads/scripts/sync-worktrees.sh << 'SCRIPT_EOF'
#!/bin/bash
...
chmod +x /Users/luoxun/dev/ads/server/ads/scripts/sync-worktrees.sh
echo "✓ sync-worktrees.sh 已更新"
