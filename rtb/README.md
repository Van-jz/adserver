## 简单介绍
几个关键的接口
1、查询当前广告消耗 https://dsp.globalgoogleplay.com/prod/rtb/wonPrice
2、设置出价频率 https://dsp.globalgoogleplay.com/dev/rtb/change/interval/{次数}，例如次数=1000，代表每1000次出价一次
3、设置每日广告消耗预算上限 https://dsp.globalgoogleplay.com/prod/rtb/setSpendingLimit/{上限值} 
4、设置当前广告消耗值 https://dsp.globalgoogleplay.com/prod/rtb/setWonPrice/{最新的消耗值}
备注：
1、如果应用重启了，需要调用第四个接口，手动设置一下最新的消耗值，消耗值在error日志中，最新的一条dayOfYear=日期天数,spendDay=消耗值所在行
2、如果容器重启了，需要手动挂载一下日志文件出来  ！！！set /data/disk0/home 为 /home才行 ！！！
