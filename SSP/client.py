...
def send_request_and_process_response():
    request_id = "id2024040821090001"
    token = "64091B01089d33D"
    publisher_id = 50000054
    sign = hmac_sha256(request_id, token)
    #adx_url = "https://ad-intl-web-beta.test.gifshow.com/rest/n/adintl/KwaiNetwork/getKNAd"
    adx_url = "https://api.mythad.com/rest/n/adintl/KwaiNetwork/getKNAd?sign=" + sign
    rtb_request = get_1_request(request_id, publisher_id)
