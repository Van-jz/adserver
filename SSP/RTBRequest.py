# 构建RTB 2.5请求的函数
def get_1_request(request_id, publisher_id):
    TagID = "8008391001"
    AppID = "800839"
    AppName = "Block Blast!"
    AppBundle = "com.block.juggle"
    AppStoreUrl = "https://play.google.com/store/apps/details?id=com.block.juggle&hl=pt-br&gl=br"

    request_payload = {
        "id": request_id,  # 唯一的请求ID
        "at": 1,  # 竞价类型，例如 2 代表第二价格拍卖
        "imp": [{  # 描述广告展示的数组
            "id": "img2024040821120003",  # Impression对象的唯一标识符
            "tagid": TagID,  # 广告位ID
            "video": {  # 视频广告的相关参数
                "w": 640,  # 视频宽度
                "h": 480,  # 视频高度
        ...
        "app": {  # 应用相关信息
            "id": AppID,  # 应用唯一标识
            "name": AppName,  # 应用名称
            "bundle": AppBundle,  # 应用包名
            "storeurl": AppStoreUrl,  # 应用商店URL
            "domain": "",  # 应用域名
            "cat": ["IAB9", "IAB17"],  # 应用分类
            "publisher": {  # 应用发布者相关信息
                "id": publisher_id,  # 发布者唯一标识
                "name": "wanfu",  # 发布者名称
                "domain": "",  # 发布者域名
